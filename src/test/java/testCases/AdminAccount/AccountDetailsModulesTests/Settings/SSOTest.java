    ...
    public void verify_add_integration() {
        try {
            ...
            commonUtils.validateGetText(commonUtils.findElementByXpath(sp.successfulMessage),
                    p.getProperty("integrationSuccessfulMessage"));
