package testCases.PurchaserAccount.HamburgerMenuModulesTests.Settings;
...
public class OnlineEducationTest extends BaseClass {
    ...
    public void verifyExperiencesForElectronicBundlesPresence() {
        ...
        try{
            ...
            boolean electronicDataConsistent = aoe.validateDataInPurchaserAccount(aoe.electronicTableRows,
                    electronicRowDataList);
