...
//            WebElement copiedLink = ob.clickOnObservationLink("dataTables_scroll",p.getProperty("purchaserAssignmentNameToClickView"));
//            System.out.println(copiedLink + " copied");
//
...
//            commonUtils.validateGetText(commonUtils.findElementByXpath(ob.registrationFormSubmission),p.getProperty("purchaserRegistrationFormValidationMessage"));
//
//        } catch (Exception e) {
//            Assert.fail();
//        }
