...
public class ObserverHomePage {
    ...
    public String imageVerificationTabText= "//button[normalize-space()='Image Verification']";
    public String idVerificationTabText = "//button[normalize-space()='ID Verification']";
}
